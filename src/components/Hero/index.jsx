...
import illustrationSrc from '../../../public/images/illustration-working.svg'
...
const Hero = () => {
  return (
    <section className="pt-2 pb-20 lg:py-32 relative overflow-hidden">
      <div className="lg:absolute lg:right-0 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-24 w-[30rem] sm:w-full max-w-[38.1875rem] ml-5 sm:mx-auto">
